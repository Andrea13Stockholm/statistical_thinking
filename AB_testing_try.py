{
    "cells": [
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": ["Needed observations (at least) for each group: 4720\n"],
                }
            ],
            "source": [
        ...
        },
        {
            ...
            "source": ['df.groupby(["group"])["user_id"].count()'],
        },
        {
            "cell_type": "code",
            "execution_count": 222,
            ...
            "source": ['pd.crosstab(df["group"], df["landing_page"])'],
        },
        {
            "cell_type": "code",
            "execution_count": 223,
            ...
            "outputs": [
                {
                    "data": {
                        ...
                        "text/plain": ["<Figure size 342x360 with 1 Axes>"],
                    },
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": ["Our new design performes poorly\n"],
                }
            ],
            "source": [
                "# Drawing conclusions\n",
    ...
    "metadata": {
        ...
        "kernelspec": {"display_name": "Python 3.8.6 64-bit", "name": "python3"},
        "language_info": {
